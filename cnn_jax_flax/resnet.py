#
# ResNet from https://uvadlc-notebooks.readthedocs.io/en/latest/tutorial_notebooks/JAX/tutorial5/Inception_ResNet_DenseNet.html
#
...
if __name__ == "__main__":
    ...
    print(resnet.tabulate(jax.random.PRNGKey(0), jnp.ones((1, 28, 28, 1))))
